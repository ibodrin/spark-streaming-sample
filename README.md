...
4. Open `http://localhost:8888` in the browser and use the pre-defined `test.ipynb` notebook to view the ingested transaction details in `Raw` and `Processed` layers with Jupyter
